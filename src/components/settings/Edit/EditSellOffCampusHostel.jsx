...
const EditSellOffCampusHostel = ({ propertyToEdit }) => {
      ...
      await editProperty(
        {
          ...
          type: "offCampusHostel",
          gender: selectedOption,
          sellersID: propertyToEdit?.sellersID,
        },
    ...
    <>
      ...
      <div className="px-6 pt-[1.69rem] pb-[4rem] max-w-[700px] w-full mx-auto">
        <div className="">
          ...
          <p className="text-[#1A0823] font-semibold mb-[0.75rem]">
            Select One
          </p>
          <div className="flex flex-col">
            {options.map((option, idx) => (
              ...
              >
                ...
                <span className=" text-base text-[#1A0823] ">
                  {option.label}
                </span>
              </label>
            ))}
...
export default EditSellOffCampusHostel;
